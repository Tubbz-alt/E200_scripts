...
%    VAL = (1+E/20.35)*[217.1035 -165.4100]; % Imaging condition for object = E200 IP or plasma exit and image = ELANEX in 2013
    VAL = (1+E/20.35)*[210.87 -164.95]; % Imaging condition for object = E200 IP or plasma exit and image = ELANEX in Fall of 2013    control_magnetSet({'LGPS:LI20:3261', 'LGPS:LI20:3311'}, VAL,  'action', 'TRIM');

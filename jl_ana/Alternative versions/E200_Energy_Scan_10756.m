...
%% Load useful variabless 
 load('./K_B1L_10756.mat');
 load('./K_B2L_10756.mat');
load('./S_num.mat');
...
if do_shot_pick;
       ...
       elseif strcmp(data_set, 'E200_10756')
          I(1:53)=1; J=[4 7 8 10 12 13 14 15 16 18 19 23 26 30 48 50 53 57 58 59 60 61 62 66 68 70 72 7 75 76 77 78 79 80 81 83 84 85 86 87 88 89 90 91 92 93 94 95 96 97 98 99 100];
...
[BETA1.img2, BETA1.ana.img, BETA1.ana.GAMMA_YIELD, BETA1.ana.GAMMA_MAX, BETA1.ana.GAMMA_DIV,BETA1.ana.xx,BETA1.ana.yy] = Ana_BETA1_img(BETA1.xx, BETA1.yy, BETA1.img(:,:,j+1));
...
for ec=ec0:size(y,2)
     ...
     if ~do_fit 
            ...
            S_ratio1L=S_BETA1./S_BETAL;
            S_ratio2L=S_BETA2./S_BETAL;
            S_ratio21=S_BETA2./S_BETA1;
...
%% In case of fit, displays the relative error bars at the fitted critical energy 
        ...
        if do_fit
            ...
            set(fig_fit_err21, 'YData', interp1(y,Err_21(1:size(y,2)),ec_fit)); 

...
BETA1.xx = 1e-3*BETA1.RESOLUTION * ( (BETA1.ROI_X-BETA1.X_RTCL_CTR+1):(BETA1.ROI_X+BETA1.ROI_XNP-BETA1.X_RTCL_CTR) );
BETA1.yy = sqrt(2) * 1e-3*BETA1.RESOLUTION * ( (BETA1.ROI_Y-BETA1.Y_RTCL_CTR+1):(BETA1.ROI_Y+BETA1.ROI_YNP-BETA1.Y_RTCL_CTR) );
...
%         title('BETA1');
  ...
  ax_BETA1 = axes('position', [0.70, 0.64, 0.28, 0.25]);
        image(BETA1.xx,BETA1.yy,BETA1.pick.img,'CDataMapping','scaled');
        colormap(cmap.wbgyr);
        fig_BETA1 = get(gca,'Children');
        daspect([1 1 1]);
        axis xy;
...
%            set(fig_fit_err2L, 'YData', interp1(y(1:size(y,2)),Err_2L,ec_fit));

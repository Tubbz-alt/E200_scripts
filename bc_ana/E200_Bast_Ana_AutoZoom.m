...
addpath('C:/Users/Bastien/Desktop/PRE/Matlab/E200_scripts/bast_ana_butterfly');
...
%  eta = 0.001*61*20.35/(20.35 + scan_info(i).Control_PV);  % For example in the dataset E200_10854 the B5D36 is set at 11.35 GeV instead of 20.35 Gev
    ...
    emit = sigma0*1000*theta*10000*(B5D36 + scan_info(i).Control_PV)/5.11; % in microns    
...
%  eta2 = 0.001*61*20.35/(20.35 + scan_info(i).Control_PV); 
    ...
    emit2 = sigma02*1000*theta2*10000*(B5D36 + scan_info(i).Control_PV)/5.11; % in microns
